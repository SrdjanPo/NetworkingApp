...
public class AutoCompleteAdapter extends ArrayAdapter<String> implements
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView myTv = (TextView) convertView.findViewById(R.id.text_view_list_item);
    ...
    public static CharSequence highlight(String search, String originalText) {
        ...
        if (start < 0) {
            ...
            while (start >= 0) {
                ...
                highlighted.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD),
