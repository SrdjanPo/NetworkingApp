...
import com.example.networkingapp.Message
import com.example.networkingapp.R
import com.example.networkingapp.User
import com.example.networkingapp.adapters.MessagesAdapter
import com.example.networkingapp.util.DATA_MESSAGES
            ...
            override fun onDataChange(p0: DataSnapshot) {
                p0.children.forEach { value ->
                    ...
                    if(!key.equals(userId)) {
                        ...
                        topNameTV.text = user?.firstName.plus(" ").plus(user?.lastName)

                        if (user?.imageUrl == "default") {
                            topPhotoIV.setImageResource(R.drawable.profile_pic)
                        }
